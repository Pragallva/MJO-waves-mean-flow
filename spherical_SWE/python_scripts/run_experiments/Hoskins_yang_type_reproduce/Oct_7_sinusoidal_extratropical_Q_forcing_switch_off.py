...
if __name__ == "__main__": 
    ...
    for H0 in [500, 2000]:
        for forcing_y_loc in tqdm([0, 4, 8, 12, 16, 20, 30, 40], desc=str(H0)):
            ...
            #     time_period   = int(sys.argv[3])
                ...
                input_file['path']          = \
                input_file['path']+'/Q_forcing_switch_off/forcing_y_%d/time_period_%d_days/'%(forcing_y_loc, input_file['time_period'])
