...
def integrate_model(input_file2):
    ...
    for ncycle in range(itmax):
        ...
        phi_forcing           = (PHI_perturb (lons, lats,  Q0, yp, xp, Lx, Ly, t, switch_on_day)[0])*time_component 
        ...
        for forcing_y_loc in tqdm([0, 4, 8, 12, 16, 20, 30, 40], desc=str(H0)):
            ...
            #     time_period   = int(sys.argv[3])
                ...
                input_file = {  'nlons'        : 256,          \
                                ...
                                'nlats'        : int(256/2), \
                                'dt'           : 150        , \
                                'itmax'        : time_period*40*int(86400/150) , \
                                'spin_up_time' : 25,     \
                                'rsphere'      : 6.37122e6  , \
                                'omega'        : 7.292e-5   , \
                                'grav'         : 9.80616    , \
                ...
                input_file['path']          = \
                input_file['path']+'/Q_forcing/forcing_y_%d/time_period_%d_days/'%(forcing_y_loc, input_file['time_period'])
