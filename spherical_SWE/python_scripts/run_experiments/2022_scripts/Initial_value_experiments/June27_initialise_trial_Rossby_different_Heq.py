                ...
                for forcing_phase_speed in [0]: ##0                                            
                    for DIPOLE_or_MONOPOLE in [True]:
                        ...
                        for alphas, switch_on_days, keep_forcing_const_for_days  in zip([100], [0], [350]):
                            ...
                            input_file['matsuno_amp_factor'] = 0.01
                            ############################################################################
                            ############################################################################
                            

                            logging_object = logruns.default_log(logfilename   = 'June27_2022_Hmean_%d_ps_%d_Q0_%d'%(\
                                                                                  input_file['Hmean'], input_file['forcing_phase_speed'], \
                                                                                  input_file['Q0']),  \
                                                                 log_directory = './log/')
