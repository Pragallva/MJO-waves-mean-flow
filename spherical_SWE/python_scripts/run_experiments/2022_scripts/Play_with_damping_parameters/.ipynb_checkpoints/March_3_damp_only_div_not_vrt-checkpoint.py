                            ...
                            for DIPOLE_or_MONOPOLE in [True]:
                                for alphas, switch_on_days, keep_forcing_const_for_days  in zip([25], [0], [350]):
                                    ...
                                    input_file = {  'nlons'        : 256        , \
                                                    ...
                                                    'FUo'          : 0 ,  'FVo' : 0 ,  \
                                                    'K_M_DIV'      : K_M_DIV*24*3600, 'K_M_VRT': 1e2*24*3600, 'K_T': 10*24*3600, \
                                    ...
                                    input_file['path']             = \
                                    input_file['path']+'/Q_forcing_%d_forcing_y_%d_Hmean_%d_forcing_phase_speed_%d_ms/damp_vrt_only_%d_days_timescale/'%(\
                                                                                    input_file['Q0'],                  input_file['yp'], \
                                                                                    input_file['Hmean'], input_file['forcing_phase_speed'], \
                                                                                    input_file['K_M_DIV']/(24*3600))
