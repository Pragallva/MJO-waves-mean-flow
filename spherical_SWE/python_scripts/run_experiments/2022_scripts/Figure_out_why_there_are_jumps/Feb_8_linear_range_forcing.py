...
#       phi_forcing           = (PHI_perturb_from_file(external_data, time = 0, switch_on_day=None)[0])
    ...
    equation_terms =  {'VRT_term1': A(VRT_term1),  'VRT_term2': A(VRT_term2),  \
                       'DIV_term1': A(DIV_term1),  'DIV_term2': A(DIV_term2),  'DIV_term3': A(DIV_term3), \
                       'DIV_term4': A(DIV_term4), 'DIV_term5': A(DIV_term5), \
                       'PHI_term1': A(PHI_term1), 'PHI_term2': A(PHI_term2), 'PHI_term3': A(PHI_term3),  \
                       'lats': sp_harmonic.lats, 'lons': sp_harmonic.lons, 'T_in_days':A(T),  \
...
if __name__ == "__main__": 
    ...
    for H0 in [2000]:  ##[0, 200,  2000, 500, 750, 1000, 1500, 2500, 3000, 3500, 4000, 4500, 5000]
                ...
                for forcing_phase_speed in [5]:                                            
                    for DIPOLE_or_MONOPOLE in [True]:
                        for switch_off_day in [405]:
                            ...
                            logging_object = logruns.default_log(logfilename   = 'linear_force', \
                            ...
                            input_file = {  'nlons'        : 256        , \
                                            ...
                                            'path'         : '/data/pbarpanda/spherical_SWE/figure_out_budget/linear_Q_forcing/' } ; 
