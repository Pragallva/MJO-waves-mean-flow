                        ...
                        for DIPOLE_or_MONOPOLE in [True]:
                            ...
                            for alphas, switch_on_days, keep_forcing_const_for_days  in zip([25], [0], [1000]):
                                ...
                                input_file = {  'nlons'          : 256        , \
                                                ...
                                                'path'           : '/data/pbarpanda/spherical_SWE/evaluate_final_budget/resting_basic_state_diff_Heq/' } ; 
                                ...
                                input_file['path']             = \
                                input_file['path']+'/dt_%d_Q_forcing_%d_forcing_y_%d_Hmean_%1.1f_forcing_phase_speed_%d_ms/U_up_days_%d/'%(\
                                                                                input_file['dt'],\
                                ...
                                logging_object = logruns.default_log(logfilename   = 'Sep5_Hmean_%1.1f_ps_%d_Q0_%d'%(\
                                                                                      input_file['Hmean'], input_file['forcing_phase_speed'], \
                                                                                      input_file['Q0']),  \
                                                                     log_directory = './log/')
