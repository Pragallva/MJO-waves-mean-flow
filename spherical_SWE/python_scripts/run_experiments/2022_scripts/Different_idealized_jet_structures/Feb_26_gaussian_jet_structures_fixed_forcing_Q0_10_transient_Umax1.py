...
#         if int(t/(24*3600)) > 5 :
#             if t % (3*3600) == 0: ### Save every 3 hours        
#                 temp_dict = {'phiT':phiT, 'UU': UU, 'lat':np.rad2deg(lats), 'phiT0':phiT0, 'mu':mu, 'sigma':sigma}
                    ...
                    for forcing_phase_speed in [0]: ##0                                            
                        for DIPOLE_or_MONOPOLE in [True]:
                            ...
                            for alphas, switch_on_days, keep_forcing_const_for_days  in zip([25], [0], [350]):
                                ...
                                for mu, sigma, den in zip([45, 55], [10, 10], [1.6, 1]):   #### Not too sharp zonal wind but at different jet position
                                    ...
                                    input_file = {  'nlons'        : 256        , \
                                                    ...
                                                    'path'           : '/data/pbarpanda/spherical_SWE/evaluate_final_budget/transient_U_changing_jet_struct2/',\
                                    ...
                                    input_file['U_up_days']      = (550 - input_file['alpha']*3)//2
