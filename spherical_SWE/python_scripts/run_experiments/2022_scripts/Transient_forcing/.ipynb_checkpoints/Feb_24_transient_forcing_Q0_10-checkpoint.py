...
if __name__ == "__main__": 
    ...
    for H0 in [0, 3000, 1000]:   #, 3000, 3500, 4000, 4500, 5000]:  
                ...
                for forcing_y_loc in [0]:  
                    for forcing_phase_speed in [0]:                                            
                        for DIPOLE_or_MONOPOLE in [True]:
                            ...
                            for alphas, switch_on_days, keep_forcing_const_for_days  in zip([5, 20], [45, 80], [120, 120]):
                                ...
                                input_file = {  'nlons'        : 256        , \
                                                ...
                                                'path'         : '/data/pbarpanda/spherical_SWE/evaluate_final_budget/transient_Q_forcing/' } ; 

                                input_file['ntrunc']         = int(input_file['nlons']/3)
                                input_file['nlats']          = int(input_file['nlons']/2)
                                input_file['itmax']          = 350*int(86400/int(input_file['dt']))   #### Here 150 is in the units of days
                                input_file['Hmax']           = H0
                                ...
                                input_file['path']             = \
                                input_file['path']+'/dt_%d_Q_forcing_%d_forcing_y_%d_Hmean_%d_forcing_phase_speed_%d_ms/alpha_%d_switch_on_%d_day/'%(\
                                                                                input_file['dt']    ,\
                                                                                input_file['Q0'],                  input_file['yp'], \
                                                                                input_file['Hmean'], input_file['forcing_phase_speed'], \
                                                                                input_file['alpha'], input_file['switch_on_day'] )
