...
if __name__ == "__main__": 
    ...
    for H0 in tqdm([0,2000]):          
        for forcing_y_loc in [0]:            
            for Q0 in [1500]:                
                for forcing_phase_speed in [0]: #[0, 5, 15]:                                            
                    for DIPOLE_or_MONOPOLE in [False]:
                        for switch_off_day in [405]: #[405, 200]:
                            ...
                            logging_object = logruns.default_log(logfilename   = 'all_globe', \
