...
if __name__ == "__main__": 
    ...
    for H0 in tqdm([0, 2500]):  ##[0, 200,  2000, 500, 750, 1000, 1500, 2500, 3000, 3500, 4000, 4500, 5000]
        for forcing_y_loc in tqdm([0], desc=str(H0)):            
            for Q0 in [500]:                
                    ...
                    for DIPOLE_or_MONOPOLE in [True]:
                        for switch_off_day in [405]:
                            ...
                            input_file = {  'nlons'        : 256        , \
                                            ...
                                            'path'         : '/data/pbarpanda/spherical_SWE/Hoskins_type_forcing/linear_Q_forcing/' } ; 
