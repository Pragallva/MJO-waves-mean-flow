...
if __name__ == "__main__":
    ...
    for extra in ['U_up_days_217'] :#'alpha_5_switch_on_45_day', 'alpha_20_switch_on_80_day']:U_up_days_170
        for Hmean in ([500]):
            for H0 in ([5000]) : #3500 #3000, 1000, 0]): #0, 500, 1000, 1500, 2000, 2500, 3000, 3500 #0, 1000, 'alpha_20_switch_on_80_day'
                for loc in [0]:
                    for Q0 in ([10]):       #50, 500         #10, 100 
                        ...
                        source  = '/data/pbarpanda/spherical_SWE/evaluate_final_budget/transient_U_fixed_forcing/dt_150_Q_forcing_%d_forcing_y_%d_Hmean_%d_forcing_phase_speed_%d_ms/%s/H0_%d/'%(Q0, loc, Hmean, ps, extra, H0)
